...
<b>Mobilidade Erasmus+ KA1</b><br>
Metodologias Ativas para o Ensino e a Aprendizagem<br>
Madrid, maio 2026<br>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
  <div class="font-serif text-5xl">Arrifana, 17 de abril de 1809</div>
  <div v-click class="font-serif text-3xl opacity-80">Só não teve pintor</div>
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-8 font-serif text-5xl">
  <div>Quem decide?</div>
  <div v-click>Quem paga?</div>
  <div v-click class="text-red-700">Quem fica fora do <i>frame</i>?</div>
</div>
...
<div class="absolute inset-0 flex items-center justify-center">
  <img src="./madrid-2026/palacio-real-2-maio.jpeg" class="max-h-80 object-contain" />
</div>
...
<div class="absolute inset-0 flex items-center justify-center">
  <img src="./madrid-2026/estatua-goya.jpg" class="max-h-100 object-contain" />
</div>
...
::right::
<img src="./goya/goya-3-maio.jpg" class="h-full object-contain" />
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
  <div class="font-serif text-6xl">context4content</div>
  <div v-click class="font-serif text-2xl opacity-80">O contexto não ilustra o conteúdo.</div>
  <div v-click class="font-serif text-2xl opacity-80">O contexto é o conteúdo.</div>
</div>
...
<div class="mt-8 flex flex-col gap-3 text-3xl font-serif">
  <div v-click>Alto-mar</div>
  <div v-click>À deriva</div>
  <div v-click>Vazio</div>
  <div v-click>No espaço</div>
  <div v-click>Piratas</div>
  <div v-click>Naufrágio</div>
</div>
...
<div v-click class="absolute bottom-[30px] left-[100px]">
  <div class="text-6xl font-bold font-sans">3.16</div>
  <div>Augusto Alves da Silva, 3.16, 2003.<br>Coleção Norlinda e José Lima.</div>
</div>
...
<div class="absolute inset-0 flex items-center justify-center gap-8">
  <img src="./oliva/3-16-decifrar-imagem.jpg" class="h-full object-contain" />
  <img src="./oliva/3-16-jornal-publico.jpg" class="h-full object-contain" />
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center text-center gap-4">
  <div v-click class="text-6xl font-bold font-sans">3.16</div>
  <div v-click class="text-3xl">16 de março de 2003</div>
  <div v-click class="text-3xl">Cimeira das Lajes</div>
</div>

<div v-click class="absolute inset-0 flex items-center justify-center">
  <img src="./oliva/cimeira-lajes.jpg" class="max-h-80 object-contain" />
</div>
...
<div v-click class="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/60">
  <div class="font-serif text-5xl">"O fotojornalismo não produz</div>
  <div class="font-serif text-5xl">uma imagem imparcial, nunca.</div>
  <div class="font-serif text-5xl">Porque nenhuma fotografia o é."</div>
</div>
...
<div class="mt-8 flex flex-col gap-3 text-3xl font-serif">
  <div v-click>Migração</div>
  <div v-click>Opressão</div>
  <div v-click>Controlo</div>
  <div v-click>Sem controlo</div>
  <div v-click>Saque</div>
  <div v-click class="text-red-700">Piratas</div>
</div>
...
<div class="absolute inset-0 flex items-center justify-center">
  <div class="text-red-700 text-9xl font-serif">Piratas</div>
</div>
...
::right::
<div v-click class="text-2xl text-right font-sans">Os alunos também <br> não estavam.</div>
...
<div v-click class="absolute inset-0 flex items-center justify-center bg-black/75">
  <img src="./guernica/history-rhyme.jpeg" class="max-h-80 object-contain" />
</div>
...
<div class="absolute inset-0 flex items-center justify-center gap-0">
  <img src="./guernica/pomba-paz.jpg" class="max-h-80 object-contain" />
  <img v-click src="./guernica/guernica.jpeg" class="max-h-80 object-contain" />
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
  <div class="font-serif text-9xl">3 de maio</div>
  <div v-click class="font-sans text-xl opacity-80">Fuzilamento em Madrid</div>
  <div v-click class="font-sans text-xl opacity-80">Chegada a Madrid</div>
  <div v-click class="font-sans text-3xl opacity-80">Dia Mundial da Liberdade de Imprensa</div>
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-6 font-serif text-4xl">
  <div>O fotojornalismo não é isento.</div>
  <div v-click>A arte não é isenta.</div>
  <div v-click>A pedagogia também não é.</div>
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
  <div class="font-serif text-6xl">context4content</div>
  <div class="font-serif text-2xl opacity-80">O contexto não ilustra o conteúdo.</div>
  <div class="font-serif text-2xl opacity-80">O contexto é o conteúdo.</div>
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
  <div class="font-serif text-3xl">Quem decide?</div>
  <div v-click class="font-serif text-3xl">Quem paga?</div>
  <div v-click class="font-serif text-3xl text-red-700">Quem fica fora do frame?</div>
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
  <div class="font-serif text-5xl opacity-80">Write!</div>
  <div class="font-serif text-3xl opacity-80">You are the intellectuals.</div>
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
  <img src="./xtra/qr-footscapes.png" class="max-h-80 object-contain" />
  <div class="font-sans text-xl opacity-80">https://tipoexquisito.github.io/footscapes/</div>
</div>
...
<div class="absolute inset-0 flex items-center justify-center">
  <img src="./madrid-2026/sala-equis-1.jpg" class="h-full object-contain" />
  <img src="./madrid-2026/sala-equis-2.jpg" class="h-full object-contain" />
</div>
...
<div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
  <div class="font-serif text-5xl ">Fiat Corde</div>
  <div class="font-serif text-xl opacity-80">Love, love is a verb, love is a doing word.</div>
</div>
