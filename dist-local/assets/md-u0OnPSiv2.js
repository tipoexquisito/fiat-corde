...
//#region slides.md__slidev_37.md
var _sfc_main = {
	...
	setup(__props) {
		...
		$clicksContext.setup();
		return (_ctx, _cache) => {
			return openBlock(), createBlock(image_default, normalizeProps(guardReactiveProps(unref(frontmatterToProps)(unref($frontmatter), 36))), null, 16);
		};
	}
};
//#endregion
